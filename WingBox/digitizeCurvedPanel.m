...
y_data_min = 4;   % Data y-coordinate of the origin
...
while true
    ...
    n = length(webBuckling);
    webBuckling(n+1).x_data = x_data;
    webBuckling(n+1).y_data = y_data;
    figure(1)
    save("webBuckling.mat","webBuckling")
end